...
// following order: length, width, height and store these three values in this.length, this.width
// and this.height respectively.
...
// II. Cube
// class Cube is a subclass of class Cuboid. The constructor function of Cube should receive one
// argument only, its length, and use that value passed in to set this.length, this.width and
// this.height.
