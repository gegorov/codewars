// n this kata you have to implement a base converter, which converts positive integers between
...
// JavaScript. In Haskell, intermediate results will probably be too large for Int.
// The function must work for any arbitrary alphabets, not only the pre-defined ones
// You don't have to consider negative numbers

const convert = (str, fromBase, toBase) => parseInt(str, fromBase.length).toString(toBase.length);
...
console.log(convert('10', Alphabet.DECIMAL, Alphabet.HEXA_DECIMAL));
